...
namespace stats
{
    ...
    public:
        ...
        static constexpr int SPEEDSTER_EASY = 120;
        static constexpr int SPEEDSTER_MEDIUM = 240;
        static constexpr int SPEEDSTER_HARD = 360;
        static constexpr int SPEEDSTER_EXPERT = 480;
        static constexpr int SPEEDSTER_EXTREME = 600;
        static constexpr int GRADUATE_MIN_WINS = 20;
